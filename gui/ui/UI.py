...
"}")
        ...
        self.log_out_button = QPushButton(self.leftbox_bottom)
        self.log_out_button.setObjectName(u"log_out_button")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.log_out_button.sizePolicy().hasHeightForWidth())
        self.log_out_button.setSizePolicy(sizePolicy2)
        self.log_out_button.setMinimumSize(QSize(60, 30))
        self.log_out_button.setMaximumSize(QSize(60, 30))

        self.verticalLayout_3.addWidget(self.log_out_button, 0, Qt.AlignmentFlag.AlignHCenter)

        self.label_6 = QLabel(self.leftbox_bottom)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setMaximumSize(QSize(16777215, 12))
        font1 = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.leftbox_top.sizePolicy().hasHeightForWidth())
        self.leftbox_top.setSizePolicy(sizePolicy3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u9000\u51fa\u767b\u5f55", None))
