...
from cv_module.yolov10.nn.modules import v10Detect
from cv_module.yolov10.utils.loss import v10DetectLoss
...
def torch_safe_load(weight):
    ...
    try:
        with temporary_modules(
            ...
            if "yolov10" in file:
                # 确保正确导入模块
                from cv_module.yolov10.nn.modules import block
                from cv_module.yolov10.nn.modules import head
                # 在加载模型前映射旧模块到新位置
